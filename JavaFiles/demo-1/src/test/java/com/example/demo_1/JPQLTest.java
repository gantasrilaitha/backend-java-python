...
public class JPQLTest {//JPQL=JAVA PERSISTENCE QUERY LANGUAGE
	...
	//JOIN => Select c, s from Course c JOIN c.students s ;[no null]
	//LEFT JOIN => Select c, s from Course c LEFT JOIN c.students s;[has null]
	//CROSS JOIN => Select c, s from Course c, Student s;eg: 3 and 4 =>3 * 4 = 12 Rows
		@Test
		public void join(){
